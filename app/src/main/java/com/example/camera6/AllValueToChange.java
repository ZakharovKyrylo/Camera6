...
public class AllValueToChange {
    public static final String myLog = "My Log - ";
    public static final String mCameraID = "0"; // выбираем какую камеру использовать 0 - основная, 1 - фронтальная
    public static final String folderName = "DETECTION";

    public static final int recordTime = 2 * 60 * 1000; // 2 * 60 * 1000
